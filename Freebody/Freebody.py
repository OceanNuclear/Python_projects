...
#Birmingham, UK
#Intended to plot the velocity and position of a rocket in space, with a nozzle that's not parallel to the axis of it's centre of mass.
#(this assumes that the spaceship is not subjected to any other forces, and does not lose any significant amount of mass)
