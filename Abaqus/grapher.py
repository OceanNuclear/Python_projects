...
#This program goes into a certain directory to find a .txt data file, 
#and then save the resulting graph in that directory
import numpy as np
...
#plot
plt.plot(Count, label = str("Rock Sample"))
