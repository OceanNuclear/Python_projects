...
if __name__=="__main__":
	...
	RotationMatrices = ReadR(directory+"zzAllOrientation_frame1.txt")
	numGrains = len(RotationMatrices)
	#numGauss = len(ReadR(directory+".txt"))/numGrains
	...
	for frame in range (preNumFrame,numFrame):
		fileName = directory+"zzAllOrientation_frame"+str(frame+1)+".txt"
