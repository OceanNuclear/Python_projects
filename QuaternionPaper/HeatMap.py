...
if __name__=="__main__":
	...
	#frameNumstr=str(360)
	frameNumstr = str(int(input("Please choose a frame to plot:")))
	...
	'''
	RealData = True
#	RotationMatrices = ReadR(directory+frameNumstr+"FrameRotationMatrices.txt")
#	rho = Readrho(directory+"DislocationDensityFrame"+frameNumstr+"UnaxialNew.txt")

	RotationMatrices = ReadR(directory+"AverageOrientation_frame"+frameNumstr+".txt")
	rho = ReadX(directory+"IntragrainOrientationScatter_frame"+frameNumstr+".txt")
	...
	plt.title("Heat map of GOS at frame "+frameNumstr)
