%This script plots the dot map for the orientations across all 129 frames
...
n=length(A)/3;                           % n is the number of sets of Euler angles
...
% path to files
pname = '\\ADF\Storage\G\S\GXS465\MATLAB\mtex-4.5.2';
