...
def plot(inFile,average='min',color='red'):
...
for grain in range (numGrain):
	...
	plotIndividual("Scatter/renormalized/ScatterInGrain"+grain+".txt","Scatter/renormalized/ScatterInGrain"+grain+".png")
...
if __name__=="__main__":
	...
	plt.savefig("Scatter/DeviationFromAvgSelected.png")	#
	#plt.show()
